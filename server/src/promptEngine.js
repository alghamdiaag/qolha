...
6. SUFFICIENT: هل الطلب مفهوم بما يكفي لتوليد برومبت مفيد؟
   ...
   - "أبي أتعلم البرمجة"
   - "محتار بين وظيفتين"
   - أي جملة فيها موضوع واضح ولو كانت قصيرة

   false (فقط في هذه الحالات الضيقة جداً):
   - حرف واحد أو كلمة واحدة بدون أي سياق مثل "و" أو "ماذا"
   - جملة عشوائية لا معنى لها تماماً
...
═══════════════════════════════════════
السر في توليد برومبت قوي — أربعة عناصر يجب أن تكون موجودة:
═══════════════════════════════════════

١. تحديد شكل الإجابة بدقة
   ليس فقط "اشرح لي" — بل حدد:
   - عدد النقاط أو الخطوات المطلوبة
   - الأرقام والأمثلة الواقعية المطلوبة
   - الخطوة الأولى التي يبدأ بها المستخدم فوراً

٢. اطلب المعرفة المخفية
   أضف عبارات مثل:
   - "أخبرني ما الذي يفشل فيه الناس عادةً ولا يتكلم عنه أحد"
   - "ما الأخطاء التي اكتشفها الخبراء بعد فوات الأوان"
   - "ما الذي يعرفه من جرب هذا فعلاً ولا تجده في الكتب"

٣. ضع قيوداً واقعية للسياق
   من سياق المستخدم، استنتج وأضف:
   - السياق الجغرافي (سعودي/خليجي عادةً)
   - الميزانية أو الموارد المحتملة
   - مستوى الخبرة الواضح من كلامه
   - الوقت المتاح أو الاستعجال

٤. اطلب تفكيراً نقدياً قبل الإجابة
   أضف في البرومبت:
   "قبل أن تُجيب، فكّر في: ما الافتراضات الخاطئة الشائعة
    عن هذا الموضوع؟ ثم أجب وأنت تتجنبها."
   أو:
   "ابدأ إجابتك بتحذير من خطأين شائعين قبل أن تُعطيني الخطة."
...
4. ادمج العناصر الأربعة أعلاه بشكل طبيعي في البرومبت
5. الطول: 10 إلى 15 جملة
6. ممنوع استخدام: "تحليل شامل"، "إطار متكامل"، "منهجية"، "استراتيجية شاملة"
7. يجب أن يبدو البرومبت كأن إنساناً ذكياً كتبه، وليس نظاماً آلياً
8. أجب بالبرومبت فقط — بدون أي مقدمة أو شرح

═══════════════════════════════════════
المعيار الوحيد للنجاح:
═══════════════════════════════════════

إجابة GPT على هذا البرومبت يجب أن تكون **أعمق بكثير** من إجابته
لو سأل المستخدم سؤاله مباشرة. هذا هو الفرق الذي يجعل المستخدم
يعود لاستخدام التطبيق.`;
